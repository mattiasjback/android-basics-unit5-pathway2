...
class LetterListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dataStore = SettingsDataStore(requireContext())

        dataStore.preferencesFlow.asLiveData().observe(viewLifecycleOwner) { value ->
        ...
        return when (item.itemId) {
            R.id.action_switch_layout -> {
                ...
                lifecycleScope.launch {
                    dataStore.saveLayoutToPreferencesStore(isLinearLayoutManager, requireContext())
                }
